...
import NGOBookOrganization.NGOWorkAreaJPanel;
 ...
 * @author Dell
 */
public class NGOBookDepartmentRole extends Role {
    
    @Override
    public String toString(){
        return Role.RoleType.NGOBookDepartment.getValue();
    }
    ...
    public JPanel createWorkArea(JPanel userProcessContainer,BookCatalogue bookCatalogue, UserAccount account, Organization organization, Enterprise enterprise, EcoSystem business) {
        return new NGOWorkAreaJPanel(userProcessContainer, account, (NGOBookOrganization) organization, enterprise,business);
    }
